...
<head>
<title>Inscription | Cinématlot.com - Un océan de nouveautés</title>
...
<!-- CONTENT -->
            ...
            <form action="inscription_traitement.php" method="post">
                ...
                <div class="form-group">
                    <input type="text" name="pseudo" class="form-control" placeholder="Nom d'utilisateur" required="required" autocomplete="off">
                </div>
                <div class="form-group">
                ...
                <p class="text-center"><a href="index.php">Connexion mon capitaine</a></p>
            </form>
        </div>
        <style>
            .login-form {
